...
function PropertyListByCategory() {
    ...
    const deleteProperty = async (propertyId) => {
        try {
            await axios.delete(`http://localhost:8000/Property/property-delete/${propertyId}/`);
    ...
    useEffect(() => {
        const fetchProperties = async () => {
            if (selectedCategoryId !== null && selectedServiceId !== null) {
                try {
                    const response = await axios.get(`http://localhost:8000/Property/properties-by-category-and-service/${selectedCategoryId}/${selectedServiceId}/`);
    ...
    const renderProperties = () => {
        ...
        return currentProperties.map(property => (
            <tr key={property.id}>
                ...
                <td><img src={`http://localhost:8000/Property${property.image}`} alt={property.property_titre} className="img-fluid" style={{ maxWidth: '50px', maxHeight: '50px' }} /></td>
                <td>
